    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-info-circle" aria-hidden="true"></i>Group info</a></li>
                    <li><a href="{{url('admin/survey')}}"><i class="fa fa-tachometer" aria-hidden="true"></i>Group Dashboard</a></li>
                    <li><a href="{!! url('admin/survey/create') !!}"><i class="fa fa-list-alt" aria-hidden="true"></i>Create group survey</a></li>
