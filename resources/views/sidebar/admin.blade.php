        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{!! url('admin/company') !!}"><i class="fa fa-list-alt" aria-hidden="true"></i>Profile</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="#"><i class="fa fa-spinner" aria-hidden="true"></i>Pending Survey</a></li>
                    <li><a href="#"><i class="fa fa-square-o" aria-hidden="true"></i>Open Survey</a></li>
