					...
					<div class="pull-right" >
							...
							<script>
								  ...
								  return;
										   ...
										   $.ajax({
											 method: 'POST',
											 url: window.location.protocol+"//"+window.location.host+"/"+"fincoda-phase2-complete/public/basic/language",
											 dataType: 'json',
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                ...
                                <a href="{{url('basic/profile/')}}" class="btn btn-default btn-flat">Profile</a>
