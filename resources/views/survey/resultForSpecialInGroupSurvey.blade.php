                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <div class="row pull-right" >
                       <div style="float:left;">
                         <u><a class="btn btn-lg btn-success" href="{!! url('special/survey/downloadPdf/'.$survey->id) !!}">
                           <i class="fa fa-print" style="font-size:24px;" aria-hidden="true"></i> Print report (PDF)</a></u>
                       </div>
                      &nbsp;&nbsp;&nbsp;
                       <div style="float:right;">
                         <u><a class="btn btn-lg btn-success" href="{!! url('special/survey/downloadCsv/'.$survey->id) !!}">
                    ...
                    <div class="tab-content">
                      <div id="overview" class="tab-pane fade in active">
                        ...
                        <div class="report-caption">
                          ...
                          <div>
                            <br>
                            <h3 style="text-align: center"><b>User average per dimension VS Organization average per dimension</b></h3>
      ...
      @endif
                          ...
                          <div>
                            <table id="indicator_group_average_scores" class="table table-bordered table-striped text-center">
                              <h3 style="text-align: center;"><b>User average score per dimension VS Organization average score per dimension</b></h3>
                              <thead>
                                <tr>
                                  <th>Dimension</th>
                        ...
                        <div id="compared" class="tab-pane fade">
                          ...
                          <div class="tab-content">
                            ...
                            <div class="report-caption">
                              <h4><b>Description</b></h4>
                              <p>The bar graph shows a comparison between your score and Organization average score in this survey.
                                The table underneath this graph displays Organization average score in table format.
                              </p>
                            </div>
                            ...
                            @else
                              <script>
                                ...
                                var datasetGroupAvg = {
                                  label: 'Organization average per dimension',
                                  data: [
