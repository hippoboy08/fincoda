                  ...
                  <div class="tab-content">
                    <div id="overview" class="tab-pane fade in active">
                      <div class="row pull-right" >
                         <i class="fa fa-print" aria-hidden="true"></i> <u><a href="{!! url('admin/companySurvey/downloadAdminUserPdf/'.$survey->id) !!}">Print report (PDF)</a></u>
                         &nbsp;
                         <i class="fa fa-print" aria-hidden="true"></i> <u><a href="{!! url('admin/companySurvey/downloadAdminUserCsv/'.$survey->id) !!}">Download Excel</a></u>
                      </div>
