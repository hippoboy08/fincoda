                 ...
                 {!! Form::open(['role'=>'form','method'=>'POST']) !!}
                  ...
                  <div class="box box-primary">
                    <div class="box-body">
                       ...
                       <spand id = "tip">(special char is not allowed, except "-" and "_")</spand>
                       <br>
                           @if($errors->has('company_name'))
                               <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i>{!! $errors->first('company_name') !!}</label>
                           @endif
                        {!! Form::text('company_name',old('company_name'),['id'=>'com-name-reg','class'=>'form-control','placeholder'=>'Name of your organisation','maxlength' => "100"]) !!}
                        <spand id = "error--OrgName">* Your Organisation Name is over 100 characters</spand>
                        ...
                        <div class="form-group has-feedback">
                            <label>Phone Number <i>(example: 0123456789 )</i></label>
                            <br>
                            ...
                            {!! Form::number('phone',old('phone'),['id'=>'com-phone-reg','class'=>'form-control','placeholder'=>'123456789']) !!}
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group{!! $errors->has('password') ? ' has-error':'' !!} has-feedback">
                        ...
                        @endif
                        {!! Form::password('password',['id'=>'ad-pass-reg','class'=>'form-control','placeholder'=>'example: Password123*!!!']) !!}
